 //not the ideal way to go about it but other components are assigned fixed coordinates...

const F2 = () => {
  return (

    <footer className="absolute top-550 md:top-440 left-0 right-0 bg-black rounded-lg shadow w-full flex items-center justify-between">
